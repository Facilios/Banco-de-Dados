...
('Fabricio Damaceno', 'Rua das Flores, 123', 'Fabricio.Damaceno@gmail.com', '(11) 98765-4321', '1990-05-15'),
('Dayde Costa', 'Avenida das Palmeiras, 456', 'Deyde.Costa@gmail.com', '(21) 98765-1234', '1985-09-20'),
('Paulo Plinio', 'Rua dos Pinheiros, 789', 'Paulo.Plinio@gmail.com', '(31) 98765-5678', '1982-03-10'),
('Elma Maria', 'Rua das Tulipas, 321', 'Elma.Maria@gmail.com', '(41) 98765-8765', '1978-11-25'),
('Carlos Alves', 'Avenida dos Girassóis, 654', 'Carlos.Alves@gmail.com', '(51) 98765-4321', '1995-07-08'),
('Julio Cesar', 'Rua das Orquídeas, 987', 'Julio.Cesar@gmail.com', '(61) 98765-1234', '1987-12-03'),
('Tiago Modesto', 'Avenida dos Jasmins, 147', 'Tiago.Modesto@gmail.com', '(71) 98765-5678', '1980-02-18'),
('Jacinto Pinto', 'Rua das Margaridas, 258', 'Jacinto.Pinto@gmail.com', '(81) 98765-8765', '1993-06-30'),
('Tais Follano', 'Avenida das Violetas, 369', 'Tais.Follano@gmail.com', '(91) 98765-4321', '1975-10-12'),
('Paul Hergido', 'Rua dos Cravos, 741', 'Paul.Hergido@gmail.com', '(01) 98765-1234', '1989-04-05');
